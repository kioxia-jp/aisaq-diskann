...
#define AISAQ_SEARCH_BATCH_PQ_DIST_LOOKUP
#define AISAQ_SEARCH_AGGREGATE_CACHED_PQ_VECTORS
...
enum aisaq_size_unit {
    aisaq_size_unit_vectors = 0,
    aisaq_size_unit_bytes,
    aisaq_size_unit_milli_percent,
};
...
struct aisaq_search_config {
    ...
    enum aisaq_size_unit pq_cache_size_unit;
