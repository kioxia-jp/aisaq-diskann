...
using ais_read_nodes_nbrs_func_t = std::vector<bool>(*)(void *param, const std::vector<uint32_t> &node_ids,
...
/*
 ...
 return 0 on success
*/
int ais_create_reversed_vectors_map(uint32_t *&reversed_vectors_map,
